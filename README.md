...
timeline
    ...
    2025 : Inference-Time Safe Alignment
         ...
         : Bridging LLM Planning Agents and Formal Methods
         : LogicGuard
         : FormalBench
         : TCP
    2026 : ToolGate
...
| Contracts for tools and agents | [ToolGate](https://arxiv.org/abs/2601.04688), [AgentSpec](https://arxiv.org/abs/2503.18666), [Agent-C](https://openreview.net/forum?id=VeRehDnGJJ), [Agent Behavioral Contracts](https://arxiv.org/abs/2602.22302) |
...
| Temporal logic and runtime monitoring | [RvLLM](https://openreview.net/forum?id=XdwPWKbxd9&noteId=ZzUTHYqdwG), [Agent-C](https://openreview.net/forum?id=VeRehDnGJJ), [ProbGuard](https://arxiv.org/abs/2508.00500), [LogicGuard](https://arxiv.org/abs/2507.03293) |
...
| Formal reasoning benchmarks | [FormalBench](https://aclanthology.org/2025.acl-long.1068/), [SysMoBench](https://www.microsoft.com/en-us/research/publication/sysmobench-evaluating-ai-on-formally-modeling-complex-real-world-systems/), [ChomskyBench](https://arxiv.org/abs/2604.02709), [VLTL-Bench](https://openreview.net/forum?id=RUs4KC34yT), [PlanBench](https://arxiv.org/abs/2206.10498) |

## Papers by Venue and Year

| Year | Venue / Status | Representative Papers |
|---:|---|---|
| 2026 | ICSE / ICLR / OpenReview | [AgentSpec](https://arxiv.org/abs/2503.18666), [Agent-C](https://openreview.net/forum?id=VeRehDnGJJ), [SysMoBench](https://www.microsoft.com/en-us/research/publication/sysmobench-evaluating-ai-on-formally-modeling-complex-real-world-systems/), [Grounding Generative Planners in Verifiable Logic](https://openreview.net/forum?id=wb05ver1k8) |
| 2026 | arXiv / OpenReview submission | [ToolGate](https://arxiv.org/abs/2601.04688), [Agent Behavioral Contracts](https://arxiv.org/abs/2602.22302), [ChomskyBench](https://arxiv.org/abs/2604.02709), [VLTL-Bench](https://openreview.net/forum?id=RUs4KC34yT), [SENTINEL](https://openreview.net/forum?id=vCyxemIKLL) |
| 2025 | ACL / EMNLP / NAACL / NeurIPS | [FormalBench](https://aclanthology.org/2025.acl-long.1068/), [TCP](https://aclanthology.org/2025.emnlp-main.1142.pdf), [Real-World Planning with Formal Verification Tools](https://aclanthology.org/2025.naacl-long.176/), [RvLLM](https://openreview.net/forum?id=XdwPWKbxd9&noteId=ZzUTHYqdwG) |
| 2025 | arXiv / ASE workshop / OpenReview submission | [Inference-Time Safe Alignment](https://arxiv.org/abs/2502.01208), [Towards Formally Verifying LLMs](https://openreview.net/forum?id=evDSvZBFRP), [ProbGuard](https://arxiv.org/abs/2508.00500), [Bridging LLM Planning Agents and Formal Methods](https://arxiv.org/abs/2510.03469), [LogicGuard](https://arxiv.org/abs/2507.03293) |
...
| [Enforcing Temporal Constraints for LLM Agents](https://openreview.net/forum?id=VeRehDnGJJ) | Adharsh Kamath, Sishen Zhang, Changming Xu, Shubham Ugare, Gagandeep Singh, Sasa Misailovic | 2026 | Tools / Frameworks | ICLR 2026 Workshop VerifAI-2 / arXiv 2025 | Agent-C 面向 tool-calling agents，把“先认证再访问数据”等时序安全策略表达为 DSL，再翻译到 first-order logic。<br>系统在动作生成阶段交织 SMT solving 与 constrained generation，发现违规工具调用时回退并采样合规替代动作。<br>它把 runtime monitoring 推进到生成过程内的可执行约束层。 | - 为 agent 行为定义时序约束 DSL<br>- 将规范翻译为一阶逻辑并用 SMT 检查<br>- 在 token/action generation 中强制合规<br>- 覆盖客服与航旅订票等工具调用场景 | [OpenReview](https://openreview.net/forum?id=VeRehDnGJJ)<br>[arXiv](https://arxiv.org/abs/2512.23738)<br>DOI: [10.48550/arXiv.2512.23738](https://doi.org/10.48550/arXiv.2512.23738) |
| [AgentSpec: Customizable Runtime Enforcement for Safe and Reliable LLM Agents](https://arxiv.org/abs/2503.18666) | Haoyu Wang, Christopher M. Poskitt, Jun Sun | 2026 | Tools / Frameworks | ICSE 2026 | AgentSpec 提供轻量 DSL，让用户以 triggers、predicates 与 enforcement mechanisms 表达 agent 运行时约束。<br>论文覆盖代码执行、embodied agents 与自动驾驶等场景，强调毫秒级开销下的可解释运行时执行。<br>它补足了从自然语言 guardrails 到结构化 enforcement rules 的工程接口。 | - 提出可定制 runtime enforcement DSL<br>- 支持触发器、谓词与阻断/修改等执行动作<br>- 在多类 agent 场景中评估安全约束<br>- 探索由 LLM 自动生成 enforcement rules | [arXiv](https://arxiv.org/abs/2503.18666)<br>DOI: [10.48550/arXiv.2503.18666](https://doi.org/10.48550/arXiv.2503.18666) |
| [ProbGuard: Probabilistic Runtime Monitoring for LLM Agent Safety](https://arxiv.org/abs/2508.00500) | Haoyu Wang, Christopher M. Poskitt, Jiali Wei, Jun Sun | 2025 | Tools / Frameworks | arXiv 2025, Preprint | ProbGuard 把 agent execution 抽象为 symbolic states，并从轨迹中学习 discrete-time Markov chain 来预测未来进入 unsafe states 的概率。<br>相比只在违规即将发生时阻断的 reactive monitor，它试图提前预警并介入长时程安全风险。<br>该工作把概率模型检查思想引入 LLM agent runtime safety。 | - 学习 DTMC 以预测未来安全风险<br>- 在运行时基于阈值触发干预<br>- 引入 semantic validity constraints 与 PAC-style 保证<br>- 覆盖自动驾驶与 embodied household agents | [arXiv](https://arxiv.org/abs/2508.00500)<br>DOI: [10.48550/arXiv.2508.00500](https://doi.org/10.48550/arXiv.2508.00500) |
| [RvLLM: LLM Runtime Verification with Domain Knowledge](https://openreview.net/forum?id=XdwPWKbxd9&noteId=ZzUTHYqdwG) | Yedi Zhang et al. | 2025 | Tools / Frameworks | NeurIPS 2025 poster | RvLLM 从 runtime verification 角度出发，设计面向领域专家的轻量规范语言 ESL。<br>其核心思想不是让 LLM 自由发挥，而是在运行时对领域规则进行解释、监控与校验。<br>适合金融、医疗、工业控制等对领域知识一致性要求高的场景。 | - 设计轻量规范语言 ESL<br>- 结合上下文解释与运行时推理<br>- 突出 domain knowledge 的显式注入<br>- 面向高风险应用场景 | [OpenReview](https://openreview.net/forum?id=XdwPWKbxd9&noteId=ZzUTHYqdwG) |
...
| Title | Authors | Year | Category | Venue / Status | Summary | Contributions | Links |
|---|---|---:|---|---|---|---|---|
| [Grounding Generative Planners in Verifiable Logic: A Hybrid Architecture for Trustworthy Embodied AI](https://openreview.net/forum?id=wb05ver1k8) | Feiyu Wu et al. | 2026 | Applications | ICLR 2026 Poster | 该工作提出 hybrid neuro-symbolic 架构，把 formal verifier 置于生成式 planner 的环内，而不是在生成完成后简单打分。<br>LLM 负责高层生成，逻辑验证器负责约束安全性与可执行性，从而提升 embodied planning 的可信度。<br>这类设计体现了生成与验证闭环的应用潜力。 | - verifier 进入 planning loop<br>- 面向 embodied AI 的生成式规划<br>- 用 verifiable logic 约束 plan 安全性<br>- 体现 neuro-symbolic 混合范式 | [OpenReview](https://openreview.net/forum?id=wb05ver1k8) |
...
| [Bridging LLM Planning Agents and Formal Methods: A Case Study in Plan Verification](https://arxiv.org/abs/2510.03469) | Keshav Ramani, Vali Tawosi, Salwa Alamir, Daniel Borrajo | 2025 | Applications | ASE 2025 AgenticSE Workshop / arXiv 2025 | 该工作把自然语言计划转换为 Kripke structures 与 LTL，再用 model checking 评估 plan 与 expected behavior 是否一致。<br>它将 plan verification 从经验性分类推进到可检查的形式模型层，同时指出语义级完美 formalization 仍然困难。<br>适合连接 PlanBench、计划验证与 agent 行为审计。 | - 将自然语言计划形式化为 Kripke structures<br>- 用 LTL 与 model checking 检查计划行为<br>- 在 PlanBench 风格数据上评估 plan verification<br>- 明确区分语法正确与语义正确的 formalization | [arXiv](https://arxiv.org/abs/2510.03469)<br>DOI: [10.48550/arXiv.2510.03469](https://doi.org/10.48550/arXiv.2510.03469) |
...
| [SysMoBench: Evaluating AI on Formally Modeling Complex Real-World Systems](https://www.microsoft.com/en-us/research/publication/sysmobench-evaluating-ai-on-formally-modeling-complex-real-world-systems/) | Qian Cheng et al. | 2026 | Benchmarks | ICLR 2026 | SysMoBench 评估 AI 是否能为真实复杂系统生成形式模型，而不是只在小型代码片段上写规范。<br>它以 TLA+ 为主要规范语言，自动检查语法、运行时正确性、与系统代码的一致性以及 invariant correctness。<br>该基准把 LLM/agent formal modeling 能力放到并发和分布式系统场景中考察。 | - 聚焦真实系统级 formal modeling<br>- 使用 TLA+ 建模并发与分布式系统<br>- 自动评估模型语法、运行与不变量正确性<br>- 覆盖 Etcd、Redis、ZooKeeper 与 OS artifacts | [Microsoft Research](https://www.microsoft.com/en-us/research/publication/sysmobench-evaluating-ai-on-formally-modeling-complex-real-world-systems/) |
